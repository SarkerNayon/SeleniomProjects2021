...
public class B04_use_of_mouse_hover_over_getText {
	WebDriver driver;
	...
	public void whyGithubButton() throws InterruptedException {
		...
		WebElement whyGithub = driver.findElement(By.xpath(
				"(//summary[@class='HeaderMenu-summary HeaderMenu-link px-0 py-3 border-0 no-wrap d-block d-lg-inline-block'])[1]"));
		Thread.sleep(3000);
	...
	public void getTextTest() {
		...
		System.out.println("The " + whyGithub.getText());
		}
